...
def save_segments_to_json(segments_list, output_folder="data_augmentation"):
...
def main():
    ...
    # Save augmented dataset as JSON files
    print("\nSaving augmented data as JSON files...")
    save_segments_to_json(all_segments, output_folder="data_augmentation")

    print(f"Total segments saved: {len(all_segments)}")
